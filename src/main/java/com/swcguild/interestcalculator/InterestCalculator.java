 ...
 * @author apprentice
 */
@WebServlet(name = "InterestCalculator", urlPatterns = {"InterestCalculator","/Result"})
public class InterestCalculator extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<YearResult> listYearResults = runCalculations(compoundsPerYear, principal, years, pInterest);
    ...
    private List<YearResult> runCalculations(int compoundsPerYear, double principal, int years, double pInterest) {
        YearResult year;
